...
/*
 * This model is a part of the LeadRecurrenceYearly
 * Arif Khan 2018-03-23;
 *
 */

module.exports = function(sequelize, DataTypes) {
    const LeadRecurrenceYearly = sequelize.define('LeadRecurrenceYearly', {
        id: {
    ...
    {
        tableName: 'crm_lead_recurrence_yearly'
    });

    return LeadRecurrenceYearly;
};