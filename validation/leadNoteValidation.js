/*
* This validation file is for type CrmLeadNote resolver
* Make Schema to validate CrmLeadNote User Inputs
...
let schemaCreateInput = Joi.object().keys({
	...
	LeadNoteAttachements: Joi.array().items(Joi.object().keys({
