/*
* This validation file is for type CrmLeadAttachmentAttachement resolver
* Make Schema to validate CrmLeadAttachmentAttachement User Inputs
...
let schemaCreateInput = Joi.object().keys({
	...
	LeadAttachements: Joi.array().items(Joi.object().keys({
